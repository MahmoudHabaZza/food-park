    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $edit = '<a href="' . route('admin.social-links.edit', $query->id) . '" class="btn btn-warning fas fa-edit mr-2"></a>';
                $delete = '<a href="' . route('admin.social-links.destroy', $query->id) . '" class="btn btn-danger delete-item fas fa-trash "></a>';
                return $edit . $delete;
            })
