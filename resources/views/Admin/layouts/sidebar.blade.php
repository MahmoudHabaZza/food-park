    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ setSidebarActive(['admin.dashboard']) }}"><a class="nav-link"
                    href="{{ route('admin.dashboard') }}"><i class="fas fa-fire"></i>Dashboard</a>
            </li>
            </li>
            ...
            <li
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.chef.*']) }}"><a class="nav-link"
                            href="{{ route('admin.chef.index') }}">Chefs</a></li>
                    ...
                    <li class="{{ setSidebarActive(['admin.social-links.*']) }}"><a class="nav-link"
                            href="{{ route('admin.social-links.index') }}">Social Links</a></li>
                </ul>
            </li>
            <li class="dropdown {{ setSidebarActive(['admin.order.*']) }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-box"></i>
                    <span>Orders</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ setSidebarActive(['admin.order.index']) }}"><a class="nav-link"
                            href="{{ route('admin.order.index') }}">All Orders</a></li>
                    <li class="{{ setSidebarActive(['admin.order.pending']) }}"><a class="nav-link"
                            href="{{ route('admin.order.pending') }}">Pending Orders</a></li>
                    <li class="{{ setSidebarActive(['admin.order.inprocess']) }}"><a class="nav-link"
                            href="{{ route('admin.order.inprocess') }}">In Process Orders</a></li>
                    <li class="{{ setSidebarActive(['admin.order.delivered']) }}"><a class="nav-link"
                            href="{{ route('admin.order.delivered') }}">Delivered Orders</a></li>
                    <li class="{{ setSidebarActive(['admin.order.declined']) }}"><a class="nav-link"
                            href="{{ route('admin.order.declined') }}">Declined Orders</a></li>
                </ul>
            </li>
            <li
                class="dropdown {{ setSidebarActive(['admin.product.*', 'admin.product-rating.*', 'admin.category.*']) }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.product-rating.*']) }}"><a class="nav-link"
                            href="{{ route('admin.product-rating.index') }}">Product Reviews</a></li>
                </ul>
            </li>
            <li
                class="dropdown {{ setSidebarActive(['admin.coupon.*', 'admin.delivery-area.*', 'admin.payment-gateways.*']) }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setSidebarActive(['admin.payment-gateways.*']) }}"><a class="nav-link"
            ...
            <li class="dropdown {{ setSidebarActive(['admin.reservation-times.*', 'admin.reservation.*']) }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ setSidebarActive(['admin.reservation-times.*']) }}"><a class="nav-link"
                            href="{{ route('admin.reservation-times.index') }}">Reservation Times</a>
                    </li>
            ...
            <li
                class="dropdown {{ setSidebarActive(['admin.blog-categories.*', 'admin.blogs.*', 'admin.blog-comments.*']) }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-rss"></i>
                    <span>Blog</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ setSidebarActive(['admin.blog-categories.*']) }}"><a class="nav-link"
                            href="{{ route('admin.blog-categories.index') }}">Categories</a></li>
                    ...
                    <li class="{{ setSidebarActive(['admin.blog-comments.*']) }}"><a class="nav-link"
                            href="{{ route('admin.blog-comments.index') }}">Comments</a></li>
                </ul>
            </li>
            <li class="dropdown {{ setSidebarActive(['admin.page-builder.*', 'admin.about.*', 'admin.contact.*']) }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ setSidebarActive(['admin.page-builder.*']) }}"><a class="nav-link"
                            href="{{ route('admin.page-builder.index') }}">Custom Page</a></li>
            ...
            @if (auth()->user()->role == 'super_admin')
                <li class="{{ setSidebarActive(['admin.chat.*']) }}"><a class="nav-link"
                        href="{{ route('admin.chat.index') }}"><i class="far fa-comment-dots"></i>
                        <span>Messages</span></a></li>
            @endif

            <li class="{{ setSidebarActive(['admin.menu-builder.*']) }}"><a class="nav-link"
                    href="{{ route('admin.menu-builder.index') }}"><i class="far fa-list-alt"></i>
