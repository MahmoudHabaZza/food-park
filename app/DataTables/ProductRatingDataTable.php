    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('status', function ($query) {
                $html = '<select class="form-control product-rating-status" data-id=' . $query->id . '>
            ...
            ->addColumn('action', function ($query) {
                $delete = '<a href="' . route('admin.product-rating.destroy', $query->id) . '" class="btn btn-danger delete-item fas fa-trash "></a>';
                return $delete;
            })
