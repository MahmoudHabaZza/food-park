...
class DeliveryAreaDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($query) {
            $edit = '<a href="' . route('admin.delivery-area.edit', $query->id) . '" class="btn btn-warning fas fa-edit mr-2"></a>';
            $delete = '<a href="' . route('admin.delivery-area.destroy', $query->id) . '" class="btn btn-danger delete-item fas fa-trash "></a>';
            return $edit . $delete;
        })
