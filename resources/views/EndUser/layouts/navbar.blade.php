<nav class="navbar navbar-expand-lg main_menu">
    <div class="container">
        <a class="navbar-brand" href="{{ route('home') }}">
            <img src="{{ asset('assets/EndUser') }}/images/logo.png" alt="FoodPark" class="img-fluid">
        </a>
        ...
        <ul>
            <li>
                <div class="menu_cart_img">
                    <img src="{{ asset('assets/EndUser') }}/images/menu8.png" alt="menu" class="img-fluid w-100">
                </div>
            ...
            <li>
                <div class="menu_cart_img">
                    <img src="{{ asset('assets/EndUser') }}/images/menu4.png" alt="menu" class="img-fluid w-100">
                </div>
                <div class="menu_cart_text">
            ...
            <li>
                <div class="menu_cart_img">
                    <img src="{{ asset('assets/EndUser') }}/images/menu5.png" alt="menu" class="img-fluid w-100">
                </div>
                <div class="menu_cart_text">
            ...
            <li>
                <div class="menu_cart_img">
                    <img src="{{ asset('assets/EndUser') }}/images/menu6.png" alt="menu" class="img-fluid w-100">
                </div>
                <div class="menu_cart_text">
                    <a class="title" href="#">Hyderabadi Biryani</a>
                    <p class="size">small</p>
