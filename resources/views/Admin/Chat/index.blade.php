            ...
            <div class="row align-items-center justify-content-center">
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <img alt="image" class="mr-3 rounded-circle" width="50"
                                        src="{{ asset('assets/Admin') }}//img/avatar/avatar-1.png">
                                ...
                                <li class="media">
                                    <img alt="image" class="mr-3 rounded-circle" width="50"
                                        src="{{ asset('assets/Admin') }}//img/avatar/avatar-2.png">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img alt="image" class="mr-3 rounded-circle" width="50"
                                        src="{{ asset('assets/Admin') }}//img/avatar/avatar-3.png">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img alt="image" class="mr-3 rounded-circle" width="50"
                                        src="{{ asset('assets/Admin') }}//img/avatar/avatar-4.png">
                                    <div class="media-body">
                ...
                <div class="col-12 col-sm-6 col-lg-9">
                    <div class="card chat-box" id="mychatbox">
                        ...
                        <div class="card-body chat-content" style="height: 70vh">
